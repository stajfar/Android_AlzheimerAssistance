...
import businesslogic_layer.DateTimeObj;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (bundle != null) {
			...
			for (int i = 0; i < messages.length; i++) {
				...
				LocObj.setDateTime(DateTimeObj.getCurrentDateTime());
			...
			Intent LaunchIntent = context.getPackageManager().getLaunchIntentForPackage("com.alzheimer.alzheimerassistant");
